...
- conda create -n xxx python=3.6：创建一个版本为3.6的python虚拟环境，名为xxx
...
- 判别对象的位置
    ...
    - 对象外部
    - 子类中
- [python中下划线使用](http://blog.csdn.net/bandsomekang/article/details/4030)
- 私有
...
- super
    ...
    - super与父类之间没有任何实质性挂你，但通过super可以调用到父类
...
- 菱形继承/钻石继承问题
    ...
    - 关于多继承的MRO
        ...
        - MRO列表的计算原则：
            ...
            - 如果多个类继承了同一个父类，孙子类中只会选取机场语法括号中第一个父类的父类
            
- 构造函数
    - 在对象进行实例化的时候，系统自动调用的一个函数叫构造函数，通常此函数用来对实例对象进行赋值
...
- 无论哪种修饰符都是为了对成员属性进行相应的控制
    ...
    - property：适于当前类中使用，可以控制一个类中多个属性
